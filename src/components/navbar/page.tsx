  ...
  if (userRole === "user") {
    return (
      <div className='h-14 relative z-50'>
        <div className={`fixed bg-white dark:bg-[#020817] top-0 left-0 right-0 ${darkMode && "dark"}`}>
              ...
              <div className='mr-1'>
                <DropdownMenu>
                  ...
                  <DropdownMenuContent className='border-black dark:border-white mt-2'>
                    ...
                    <DropdownMenuSeparator className='bg-black' />
                    <DropdownMenuItem className='flex items-center  justify-center dark:border-white/70 font-medium border border=gray-200 rounded-lg' onClick={bookingredirect}>My Bookings</DropdownMenuItem>
                    <DropdownMenuSeparator className='bg-black' />
    ...
    return (
      <div className='h-14 relative z-50'>
        <div className={`fixed top-0 bg-white dark:bg-[#020817] left-0 right-0 ${darkMode && "dark"}`}>
          <div className='h-14 border-b border-black dark:border-white flex justify-between items-center'>
            <div className='ml-4 mr-4 italic text-2xl font-bold tracking-tight'>
              TURFIFY
            </div>
