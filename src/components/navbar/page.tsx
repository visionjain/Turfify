        ...
        <div className='flex items-center space-x-2 mr-4'>
          ...
          <Menubar className='border-0 shadow-none p-0'>
            <MenubarMenu>
              ...
              <MenubarContent className='px-2 py-2'>
                <MenubarItem className='m-0 p-0'>
                  <Button onClick={profileredirect} variant='outline' className='dark:border-white border border-black'>Profile</Button>
                </MenubarItem>
                <MenubarSeparator />
                <MenubarItem className='m-0 p-0'>
                  <Button onClick={logout} variant='destructive' className='dark:border-white border border-black dark:bg-red-700 dark:border p-3.5'>Logout</Button>
                </MenubarItem>
              </MenubarContent>
            </MenubarMenu>
          </Menubar>
